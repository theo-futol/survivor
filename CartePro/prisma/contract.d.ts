...
export type StorageHash =
  StorageHashBase<'c65231faac1f674dc4f5664970871d5a9a2f35427c46207786fc0f58ef78d55c'>;
export type ExecutionHash =
  ExecutionHashBase<'3993a6b6a796ad86d346d4d629dafee95240fe832d3b1b87000f02730b6cf4a6'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly AdminUser: { readonly userId: CodecTypes['pg/text@1']['output'] };
    readonly BannedUser: {
    ...
    readonly FeaturedPartner: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly companyId: CodecTypes['pg/text@1']['output'];
      readonly message: CodecTypes['pg/text@1']['output'];
      readonly imageKey: CodecTypes['pg/text@1']['output'];
      readonly clickAmount: CodecTypes['pg/int4@1']['output'];
      readonly active: CodecTypes['pg/bool@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    ...
    readonly Users: {
      ...
      readonly companyId: CodecTypes['pg/text@1']['output'] | null;
      readonly accountStatus: 'PENDING' | 'ACCEPTED' | 'REFUSED' | 'INACTIF';
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly AdminUser: { readonly userId: CodecTypes['pg/text@1']['input'] };
    readonly BannedUser: {
    ...
    readonly FeaturedPartner: {
      ...
      readonly imageKey: CodecTypes['pg/text@1']['input'];
      readonly clickAmount: CodecTypes['pg/int4@1']['input'];
      readonly active: CodecTypes['pg/bool@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly company: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'company_active_idx_8af4daed';
                  readonly prefix: 'company_active_idx';
            ...
            readonly featuredPartner: {
              ...
              indexes: readonly [
                {
                  readonly name: 'featuredPartner_companyId_idx_33acc5ed';
                  readonly prefix: 'featuredPartner_companyId_idx';
                  readonly columns: readonly ['companyId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'featuredPartner_active_idx_8af4daed';
                  readonly prefix: 'featuredPartner_active_idx';
                  readonly columns: readonly ['active'];
                  readonly unique: false;
                },
                {
                  readonly name: 'featuredPartner_createdAt_idx_9575dbd7';
                  readonly prefix: 'featuredPartner_createdAt_idx';
                  readonly columns: readonly ['createdAt'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'featuredPartner';
                    readonly columns: readonly ['companyId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly userRefusalReason: {
              ...
              indexes: readonly [
                {
                  readonly name: 'userRefusalReason_userId_idx_a489d58a';
                  readonly prefix: 'userRefusalReason_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'userRefusalReason_createdAt_idx_9575dbd7';
                  readonly prefix: 'userRefusalReason_createdAt_idx';
                  readonly columns: readonly ['createdAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'userRefusalReason_agentId_idx_8d0ba4f0';
                  readonly prefix: 'userRefusalReason_agentId_idx';
                  readonly columns: readonly ['agentId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'userRefusalReason';
                    readonly columns: readonly ['agentId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly users: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'users_accountStatus_idx_66d3289d';
                  readonly prefix: 'users_accountStatus_idx';
                  readonly columns: readonly ['accountStatus'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
          ...
          readonly valueSet: {
            readonly AccountStatus: {
              ...
              readonly values: readonly ['PENDING', 'ACCEPTED', 'REFUSED', 'INACTIF'];
            };
            readonly Role: {
              readonly kind: 'valueSet';
...
> & {
  ...
  readonly roots: {
    ...
    readonly featuredPartner: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'FeaturedPartner';
    };
    readonly bannedUser: {
      readonly namespace: 'public' & NamespaceId;
    ...
    readonly userRefusalReason: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'UserRefusalReason';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          ...
          readonly FeaturedPartner: {
            ...
            readonly storage: {
              readonly table: 'featuredPartner';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                ...
                readonly clickAmount: { readonly column: 'clickAmount' };
                readonly active: { readonly column: 'active' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
          ...
          readonly UserRefusalReason: {
            ...
            readonly storage: {
              readonly table: 'userRefusalReason';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly reason: { readonly column: 'reason' };
        ...
        readonly enum: {
          ...
          readonly AccountStatus: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'INACTIF'; readonly value: 'INACTIF' },
            ];
          };
          readonly TransactionType: {
            readonly codecId: 'pg/text@1';
