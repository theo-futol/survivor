...
import { BASE_URL, USER_EMAIL, USER_PASSWORD, options as baseOptions } from './config.js';
...
/**
 * One iteration = one simulated visitor hitting the public read endpoints,
 * plus a login round-trip when credentials are provided.
 */
