...
export const companyFixture = [
  ...
  { id: EMPLOYER_COMPANY_ID, name: 'Entreprise SA', email: 'employer@example.com', siret: '11111111111111', kbisId: 'kbis-employer', description: 'Entreprise employeuse de test.', address: '1 rue A', postalCode: '75001', agentId: ADMIN_ID, reasonId: 1, categoryId: 1, verified: true, isFeatured: false, isPartner: false, active: true, createdAt: '2026-02-01T00:00:00Z' },
  { id: PARTNER_COMPANY_ID, name: 'Partenaire SARL', email: 'partenaire@example.com', siret: '22222222222222', kbisId: 'kbis-partner', description: 'Commerce partenaire de test.', address: '2 rue B', postalCode: '75002', agentId: ADMIN_ID, reasonId: 1, categoryId: 1, verified: true, isFeatured: true, isPartner: true, active: true, createdAt: '2026-02-02T00:00:00Z' },
  { id: OTHER_COMPANY_ID, name: 'Autre SA', email: 'autre@example.com', siret: '33333333333333', kbisId: 'kbis-other', description: 'Seconde entreprise employeuse de test.', address: '3 rue C', postalCode: '75003', agentId: ADMIN_ID, reasonId: 1, categoryId: 1, verified: true, isFeatured: false, isPartner: false, active: true, createdAt: '2026-02-03T00:00:00Z' },
];
